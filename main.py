from get_words_from_kindle import get_words_from_kindle
from get_highlights_from_kindle import get_highlights_from_kindle
...
def main():
    ...
    kindle_words = get_words_from_kindle()
    kindle_highlights = get_highlights_from_kindle()
